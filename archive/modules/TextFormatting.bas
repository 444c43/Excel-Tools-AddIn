...
Option Explicit
Private HeadersAS400$(0 To 38)
Private HeadersActual$(0 To 38)
...
Private Sub RemoveNumberAsTextError(cellRange$)
...
End Sub
Sub TextInCell(rge$, FontS%, FontC%, FontB As Boolean, FontV$)
    Range(rge).Select
    With Selection
        .Font.Size = FontS
    ...
    End With
End Sub
Sub ObjectFont(DocObject As Object, FontName$, FontStyle$, FontSize%, FontC As Variant)
    With DocObject
        .name = FontName
        .FontStyle = FontStyle
        .Size = FontSize
